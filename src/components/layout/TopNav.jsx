...
export default function TopNav() {
  ...
  return (
    <>
      <header className="sticky top-0 z-[50] w-full h-full p-2 bg-white flex justify-between items-center gap-[5%]">
        <div id="first-menu-part" className="flex gap-5">
          <div id="logo">
            <img
              src="./assets/logo.png"
              alt=""
              className="w-13 h-10 bg-gray-200 rounded-md"
            />
          </div>
          <div id="search">
              ...
              label={
                ...
                >
                  <div className="space-y-1 font-medium dark:text-white">
                    <div>Kaouthar ESSAHELI</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      Leader, Software enginner
                    </div>
                  </div>
                </Avatar>
              }
